...
{
    internal class GspFileOperations : BasicFileOperations, ITextFileOperations
    {


        public GspFileOperations() : base("gsp")
        {

        }

        public GspFileOperations(string filePath) : base(filePath, "gsp")
